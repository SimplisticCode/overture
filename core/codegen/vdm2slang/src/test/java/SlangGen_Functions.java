...
public class SlangGen_Functions
{
	...
	@Test public void add2Arguments() throws AnalysisException
	{
		File file = new File("src/test/resources/Functions/AddFunctionTwoArguments.vdmpp");

		List<GeneratedModule> classes = generateModules(file);

		String expectedCode = "def f(x : Z, y : Z):Z =\nx + y\n";
		String actualCode = classes.get(0).getContent();
		validateCode(expectedCode, actualCode);
	}
